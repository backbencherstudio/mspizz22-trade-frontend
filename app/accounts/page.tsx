...
export default function AccountsPage() {
  const [activeSubTab, setActiveSubTab] = useState("Realized Gain / Loss");
            ...
            <nav className="flex flex-wrap 2xl:gap-5 gap-4">
              ...
              {subItems.map((navItem, index) => (
                <button
                  ...
                  className={`cursor-pointer 2xl:text-sm text-xs font-normal tracking-[-0.07px] leading-[100%] transition-colors duration-200 ${
                    activeSubTab === navItem
